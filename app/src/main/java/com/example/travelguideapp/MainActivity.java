...
// У достопримечательности теперь есть цена билета и поле длительность осмотра в долях от суток. У пользователя есть кнопка "Создать тур", ему задается два вопроса про деньги и про дни. Система должна сгенерировать спиок подходящих туров. Туры генерирутся из списка достопримечательностей.